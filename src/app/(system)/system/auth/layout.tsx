...
export const metadata: Metadata = {
  ...
  description: "Secure authentication for the multi tenancy system management.",
};

export default function SystemAuthLayout({
  children,
}: Readonly<{
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;This multi-tenancy architecture provides unparalleled
              control, giving us the security and scalability needed to manage
              all our workspaces efficiently.&rdquo;
            </p>
